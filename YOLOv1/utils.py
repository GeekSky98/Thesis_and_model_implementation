...
def draw_bounding_box_and_label_info(image, x_min, y_min, x_max, y_max, label, confidence, color):
  draw_bounding_box(image, x_min, y_min, x_max, y_max, color)
  draw_label_info(image, x_min, y_min, label, confidence, color)
